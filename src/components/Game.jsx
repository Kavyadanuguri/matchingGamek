        ...
        <div className="grid grid-cols-3 relative ">
          {!selectedBlueCard && !selectedRedCard && completed.length === 0 && (
            <div className="absolute -top-24 right-20 animate-bounce z-10">
              <img
                className="https://res.cloudinary.com/djysychfq/image/upload/v1716783048/hmrjzpqeydlj4w1ipbhn.svg"
                src="https://res.cloudinary.com/djysychfq/image/upload/v1716784142/q8ehxii17wi8dsucvzqz.svg"
                alt="arrow"
              />
            </div>
          )}
          ...
          {selectedRedCard && !selectedBlueCard && completed.length === 0 && (
            <div className="absolute -bottom-24 left-20">
              <img
                ...
                src="https://res.cloudinary.com/djysychfq/image/upload/v1716783162/htmv2vhuscelq68sak1o.svg"
                alt="arrow"
              />
            </div>
          )}
